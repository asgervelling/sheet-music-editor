...
export default function ClefIcon(
  props: ClefIconProps & React.HTMLAttributes<HTMLDivElement>
) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em" /* Inherit parent width and height */
      height="1em"
      version="1.1"
      viewBox="0 0 15 40"
      stroke="currentColor" /* Inherit stroke */
    >
      <Icon clef={props.clef} />
    </svg>
  );
}
...
function Icon({
  clef,
}: ClefIconProps & SVGProps<SVGSVGElement>) {
  switch (clef) {
    case Clef.Treble:
      return (
